  ...
  return (
    <div className="animate-fade-in w-full max-w-[480px]">
      <div className="flex items-center gap-1.5 text-[10px] font-bold tracking-[0.15em] mb-4 uppercase">
        <Link href="/login" className="text-gray-400 hover:text-[#0D9488] transition-colors">LOGIN</Link>
        <span className="text-gray-300">/</span>
        <span className="text-[#0D9488]">SIGNUP</span>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          <label className="block text-[13px] font-bold text-foreground mb-2">Name</label>
          <input
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-4 py-3.5 bg-white border border-gray-200 rounded-[20px] text-foreground text-[15px] appearance-none outline-none focus:ring-2 focus:ring-teal/30 focus:border-teal transition-all shadow-sm"
            >
